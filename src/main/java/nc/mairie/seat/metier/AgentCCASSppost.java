...
/**
 * Objet métier AgentCCASSppost
 */
public class AgentCCASSppost extends BasicMetier {
...
/**
 * Constructeur AgentCCASSppost.
 */
public AgentCCASSppost() {
	super();
}
/**
...
protected BasicBroker definirMyBroker() { 
	return new AgentCCASSppostBroker(this); 
}
/**
 Methode à définir dans chaque objet Métier pour instancier un Broker 
* @return BasicBroker
*/
protected AgentCCASSppostBroker getMyAgentCCASSppostBroker() {
	return (AgentCCASSppostBroker)getMyBasicBroker();
}
/**
 ...
 */
public static ArrayList<AgentCCASSppost> listerAgentCCASSppost(nc.mairie.technique.Transaction aTransaction) throws Exception{
	AgentCCASSppost unAgentCCASSppost = new AgentCCASSppost();
	return unAgentCCASSppost.getMyAgentCCASSppostBroker().listerAgentCCASSppost(aTransaction);
}
/**
 ...
 * @throws Exception Exception
 */
public static AgentCCASSppost chercherAgentCCASSppost(nc.mairie.technique.Transaction aTransaction, String code) throws Exception{
	AgentCCASSppost unAgentCCASSppost = new AgentCCASSppost();
	return unAgentCCASSppost.getMyAgentCCASSppostBroker().chercherAgentCCASSppost(aTransaction, code);
}
}
