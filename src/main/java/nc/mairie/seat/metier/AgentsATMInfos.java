 ...
 */
public class AgentsATMInfos extends nc.mairie.technique.BasicMetier {
 ...
 */
public static java.util.ArrayList listerAgentsATMInfos(nc.mairie.technique.Transaction aTransaction) throws Exception{
