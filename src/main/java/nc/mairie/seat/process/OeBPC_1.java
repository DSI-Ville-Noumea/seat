...
* 
*/
public class OeBPC_1 extends nc.mairie.technique.BasicProcess {
...
//	Recherche des bpc
	java.util.ArrayList a = BPC.listerBPCEquipement(getTransaction(),equipementInfosCourant.getNumeroinventaire());
	if (null == a){
...
//	Test si ligne sélectionnée
	...
	if (numligne == 0){
		...
		BPC monBPC = (BPC)getListeBPC().get(numligne);
		setBpcCourant(monBPC);
		String test1 = equipementCourant.getNumeroimmatriculation();
		String test = equipementInfosCourant.getDesignationcarbu();
