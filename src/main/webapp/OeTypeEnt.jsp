...
<%@ include file="BanniereErreur.jsp" %>
    <TR>
      <TD style="text-align : center;" width="681"><FORM name="formu" method="POST"><SPAN class="sigp2-titre"></SPAN><FIELDSET><LEGEND class="sigp2Fieldset" align="left"></LEGEND> La liste des types d'entretiens<BR>
			<TABLE border="0" cellspacing="0" cellpadding="0" class="sigp2">
				<TR>
					<TD height="26">
				<TABLE class="sigp2" border="1" cellspacing="1">
					<TR>
						<TD width="130" class="sigp2-titre-liste">Libellé&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
				...
				<TR>
					<TD>
						<SELECT size="5" name="<%= process.getNOM_LB_LISTE_TE() %>"
...
<%} %>
				...
				<TR>
				<TD>Pour ajouter ou supprimer un type d'entretien, contactez directement le service informatique.</TD>
				</TR>
			</TABLE><br>
</FIELDSET><br>
					...
					<TABLE border="0" class="sigp2">
						<TR align="center">
							...
							<TD class="sigp2-saisie" style="text-transform: uppercase">
								...
								<INPUT type="text" size="50" name="<%= process.getNOM_EF_LIB_TE() %>"
								class="sigp2-saisie" value="<%= process.getVAL_EF_LIB_TE()%>" style="text-transform: uppercase">
								<%}else{ %>
