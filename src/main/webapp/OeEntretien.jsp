...
<TITLE>OeEntretien.jsp</TITLE>
</HEAD>
<jsp:useBean class="nc.mairie.seat.process.OeEntretien" id="process" scope="session"></jsp:useBean>
      ...
      <TD style="text-align : center;"><FORM name="formu" method="POST"><FIELDSET><LEGEND class="sigp2Fieldset" align="left"></LEGEND><TABLE border="0" cellspacing="0" cellpadding="0" class="sigp2">
				<TR>
					...
					<TABLE border="0" class="sigp2">
						<TR align="center">
							<TD width="300">La liste des entretiens</TD>
						</TR>
					</TABLE>
					</TD>
				</TR>
				<TR>
					<TD>
						<SELECT size="10" name="<%= process.getNOM_LB_ENTRETIEN() %>"
					...
					<TABLE border="0" class="sigp2">
						<TR align="center">
							...
							<TD class="sigp2-saisie" style="text-transform: uppercase; font-variant: normal">
								...
								<INPUT type="text" size="50" name="<%= process.getNOM_EF_DESIGNATION() %>"
