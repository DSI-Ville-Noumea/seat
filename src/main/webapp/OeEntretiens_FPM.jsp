...
<jsp:useBean class="nc.mairie.seat.process.OeEntretiens_FPM" id="process" scope="session"></jsp:useBean>
...
<%@ include file="BanniereErreur.jsp" %>
    <TR>
      <TD style="text-align : center;">
			<FORM name="formu" method="POST"><SPAN class="sigp2-titre"><%=process.getVAL_ST_TITRE_ACTION() %> d'un entretien pour la fiche d'entretien du petit matériel <%=process.getVAL_ST_NOFICHE() %><BR></SPAN>
