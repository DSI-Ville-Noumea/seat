...
<TITLE>OeAffectation_Agent.jsp</TITLE>
</HEAD>
<jsp:useBean class="nc.mairie.seat.process.OeAffectation_Agent"
...
<TABLE border="0" width="580" style="text-align : center;" class="sigp2">
						...
						<TBODY>
							...
							<TR>
								...
								<TD class="sigp2-saisie" colspan="5"
									style="text-transform: uppercase"><%=process.getVAL_ST_SERVICE()%><INPUT
 ...
 %><INPUT type="submit" name="<%=process.getNOM_PB_RETOUR() %>"
					value="Retour" class="sigp2-Bouton-100"> <%
 }
 %> <br>
				<%
				} else {
				...
				<TABLE border="0" class="sigp2" width="90%">
					...
					<tr>
						...
						<TABLE border="3" bordercolor="#669999" cellpadding="2"
							...
							<TR>
								...
								<%
										...
										|| process.getVAL_ST_DATEDEB().equals("")) {
								%>
								<TABLE class="sigp2">
									<TR>
						...
						<TABLE border="0" cellpadding="0" cellspacing="0" class="sigp2"
							align="center">
							<TR align="center">
								<TD width="140"><INPUT type="submit"
									name="<%= process.getNOM_PB_VALIDER() %>" value="Valider"
									class="sigp2-Bouton-100"></TD>
								<TD width="137"><INPUT type="submit"
