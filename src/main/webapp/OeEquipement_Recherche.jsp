...
<TITLE>OeEquipement_Recherche.jsp</TITLE>
</HEAD>
<jsp:useBean class="nc.mairie.seat.process.OeEquipement_Recherche" id="process" scope="session"></jsp:useBean>
...
<%@ include file="BanniereErreur.jsp" %>
    <TR>
      <TD style="text-align : center;">
			...
			name="<%=process.getNOM_PB_TRI() %>" style="visibility : hidden;"><br>
		...
		<FIELDSET><LEGEND class="sigp2Fieldset" align="left">Equipements</LEGEND><BR>
		...
		<TABLE border="0" class="sigp2">
				...
				<TABLE class="sigp2" border="0">
					<TR>
						...
						<TABLE border="0" class="sigp2">
							<TR>
								<TD class="sigp2-titre-liste">Immatriculation</TD>
							</TR>
						</TABLE>
						</TD>
				...
				<TR>
					<TD align="left">
						<SELECT size="10" name="<%= process.getNOM_LB_EQUIPEMENTINFOS() %>"
					class="sigp2-liste" style="text-transform: uppercase; width: 100%" ondblclick='executeBouton("<%= process.getNOM_PB_VALIDER()%>")'>
					<%= process.forComboHTML(process.getVAL_LB_EQUIPEMENTINFOS(),process.getVAL_LB_EQUIPEMENTINFOS_SELECT()) %>
				</SELECT>
				</TR>
			</TABLE>
				<br>
