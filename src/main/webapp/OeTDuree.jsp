...
<TITLE>OeTDuree.jsp</TITLE>
</HEAD>
<jsp:useBean class="nc.mairie.seat.process.OeTDuree" id="process" scope="session"></jsp:useBean>
...
<%@ include file="BanniereErreur.jsp" %>
    <TR>
      <TD style="text-align : center;" width="681"><FORM name="formu" method="POST"><SPAN class="sigp2-titre">Type de durée</SPAN><BR><FIELDSET><LEGEND class="sigp2Fieldset" align="left"></LEGEND> <BR>
			<TABLE border="0" cellspacing="0" cellpadding="0" class="sigp2">
				<TR>
					<TD height="26" width="126">
					<TABLE border="0" class="sigp2">
						<TR align="center">
							<TD width="122">La liste des types de durée</TD>
						</TR>
					</TABLE>
					</TD>
				</TR>
				<TR>
					<TD height="125" width="126">
						<SELECT size="10" name="<%= process.getNOM_LB_TDUREE() %>"
					class="sigp2-liste" style="text-transform: uppercase; width: 100%">
					<%= process.forComboHTML(process.getVAL_LB_TDUREE(),process.getVAL_LB_TDUREE_SELECT()) %>
					...
					<TABLE border="0" class="sigp2">
						<TR align="center">
							...
							<TD class="sigp2-saisie" style="text-transform: uppercase">
								...
								<INPUT type="text" name="<%= process.getNOM_EF_LIB_TDUREE() %>"
								class="sigp2-saisie" value="<%= process.getVAL_EF_LIB_TDUREE()%>" maxlength="30" size="30" style="text-transform: uppercase">
								<%}else{ %>
