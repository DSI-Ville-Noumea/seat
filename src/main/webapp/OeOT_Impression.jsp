...
<jsp:useBean class="nc.mairie.seat.process.OeOT_Impression" id="process" scope="session"></jsp:useBean>
...
<TITLE>OeOT_Impression.jsp</TITLE>
<STYLE type="text/css">
<!--
.imprim {
	display: block;
    ...
    <TR>
      <TD style="text-align : center;" align="right">
			<table border="0" class="sigp2" width="100%">
				<tr>
					<td class="sigp2-titre" width="40%"></td>
					<td class="sigp2-titre" align="left">ORDRE DE TRAVAIL</td>
					...
					<td class="sigp2-titre">
						<!-- <IMG src="images/print.gif" onclick="imprimOt()" id="imprimer" style="cursor : pointer;"> -->
				...
				<tr>
					...
					<CENTER><TABLE>
						<TR>
							...
							<TD><INPUT type="text" name="<%=process.getNOM_EF_EQUIP() %>" value="<%=process.getVAL_EF_EQUIP() %>" class="sigp2-saisie" size="10"></TD>
							<TD><INPUT type="submit" name="<%= process.getNOM_PB_EQUIP() %>" value="Rechercher" class="sigp2-Bouton-100"></TD>
						</TR>
					</TABLE></CENTER>
					</td>
				</tr>
					...
					<TR>
						...
						<TD class="sigp2-saisiemajuscule" style="font-size: 16px"><b><%=process.getVAL_ST_NOOT() %></b></TD>
								...
								<TR>
									...
									<TD class="sigp2-saisie" style="text-transform: uppercase" width="23"><%=process.getVAL_ST_COMPTEUR() %></TD>
								</TR>
								<TR>
									<TD width="92">DATE SORTIE</TD>
									<TD class="sigp2-saisie" width="121"><%=process.getVAL_ST_DSORTIE() %></TD>
									<TD width="11"></TD>
									<TD width="66"></TD>
									<TD class="sigp2-saisie" width="35"></TD>
								</TR>
...
<%=process.getVAL_EF_COMMENTAIRE() %>
					...
					name="<%= process.getNOM_PB_COMMENTAIRE() %>" value="Valider"
							...
							<TR>
								...
								<TR>
									...
									<%}else{ %>
										<tr>
											<td width="100%">
												<SELECT size="3" style="width: 100%"></SELECT>
											</td>
										</tr>
									<%} %>
									</TABLE>
