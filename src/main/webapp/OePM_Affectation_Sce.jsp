...
<TABLE border="0" class="sigp2">
			<TR>
				...
				<TD class="sigp2-titre"><INPUT size="1" type="text" class="sigp2-saisie" maxlength="1" name="ZoneTampon" style="display : none;">
				<INPUT type="text"
...
<%} %>
		...
		<FIELDSET><LEGEND class="sigp2Fieldset" align="left"></LEGEND><TABLE border="3" bordercolor="#669999" cellpadding="2"
			...
			<TBODY>
				<TR>
					<TD colspan="6" bgcolor="#669999" class="sigp2-titre">Infos concernant le petit matériel</TD>
				</TR>
				<TR>
					<TD>
		...
		<TABLE border="1" class="sigp2">
				...
				<TR>
					<TD align="left">
						<SELECT size="10" name="<%= process.getNOM_LB_AFFECTATION() %>" class="sigp2-liste" style="width: 100%" onclick='executeBouton("<%= process.getNOM_PB_RESPONSABLE()%>")'>
		...
		<%if (!"".equals(process.getVAL_ST_NOINVENT())) {%>
			<TABLE border="0" cellspacing="0" cellpadding="0" class="sigp2">
				<TR>
					<TD width="151"><INPUT type="submit" name="<%=process.getNOM_PB_AJOUTER() %>" value="Affecter" class="sigp2-Bouton-100"></TD>
...
<%} %>
			...
			name="<%=process.getNOM_PB_OK() %>" style="visibility : hidden;">
			<br>
		<%}else{%>
	</FIELDSET><BR>
<FIELDSET>
					...
					<tr>
						<td colspan="3">
							<TABLE border="3" bordercolor="#669999" cellpadding="2"
								...
								<TR>
									<TD colspan="3" bgcolor="#669999" class="sigp2-titre">Affectation d'un petit matériel</TD>
								</TR>
								<TR>
									<TD width="10"></TD>
									<TD><!--Détails du BPC-->
