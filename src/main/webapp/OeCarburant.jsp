      ...
      <TABLE border="0" cellspacing="0" cellpadding="0" class="sigp2">
				<TR>
					...
					<TABLE border="0" class="sigp2">
						<TR align="center">
							<TD width="122">La liste des carburants</TD>
						</TR>
					<TR align="center">
						<TD width="122">
						<TABLE border="1">
				...
				<TR>
					<TD>
						<SELECT size="5" name="<%= process.getNOM_LB_CARBURANT() %>"
					class="sigp2-liste" style="text-transform: uppercase; width: 100%">
					<%= process.forComboHTML(process.getVAL_LB_CARBURANT(),process.getVAL_LB_CARBURANT_SELECT()) %>
...
<BR>
			<TABLE border="0" cellspacing="0" cellpadding="0" class="sigp2">
				...
				<tr>
					<td height="10"><%if ("".equals(process.getVAL_ST_DESIGNATION())){ %></td>
				</tr>
				<TR>
					<TD height="26">
					<TABLE border="0" class="sigp2">
						<TR align="center">
							...
							<TD class="sigp2-saisie" style="text-transform: uppercase; font-variant: normal">
								...
								class="sigp2-saisie" value="<%= process.getVAL_EF_DESIGNATION()%>" maxlength="30" style="text-transform: uppercase; font-variant: normal" onselect="return func_1(this, event);">
							</TD>
						</TR>
					<TR align="center">
