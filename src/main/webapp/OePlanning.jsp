...
<jsp:useBean class="nc.mairie.seat.process.OePlanning" id="process" scope="session"></jsp:useBean>
							...
							<TABLE border="0">
								<TR>
									...
									<TD width="70" align="left"
										class="sigp2-titre-liste">N°OT</TD>
...
<%if (!process.isVide()){ %>
			...
			<TABLE class="sigp2" border="0">
				...
				<TABLE border="1">
					<TBODY>
						<TR>
							<TD class="sigp2-titre-liste">Immat      Entretiens                     Prévu     Type        </TD>
						</TR>
					</TBODY>
				</TABLE>
				</td>
