...
<TITLE>OeModeles_modif.jsp</TITLE>
</HEAD>
<jsp:useBean class="nc.mairie.seat.process.OeModeles_modif" id="process" scope="session"></jsp:useBean>
								...
								<TR>
									...
									<%= process.forComboHTML(process.getVAL_LB_TYPEEQUIP(),process.getVAL_LB_TYPEEQUIP_SELECT()) %>
											...
											<TR>
												...
												<TD><INPUT type="text" size="5" name="<%=process.getNOM_EF_NBPNEUAV() %>" value="<%=process.getVAL_EF_NBPNEUAV() %>" class="sigp2-saisie"></TD>
												<TD></TD>
												<TD>Carburant</TD>
									...
									<%= process.forComboHTML(process.getVAL_LB_CARBU(),process.getVAL_LB_CARBU_SELECT()) %>
											...
											<TR>
												...
												<TD><INPUT type="text" size="5"
									name="<%=process.getNOM_EF_NBPNEUAR() %>"
									...
									class="sigp2-saisie" maxlength="5"></TD>
												<TD></TD>
												<td>Type de pneu</td>
												<td><SELECT name="<%=process.getNOM_LB_PNEU() %>"
									class="sigp2-liste"
									style="height: 100%; text-transform: uppercase;"
