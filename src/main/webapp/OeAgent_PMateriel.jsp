...
<jsp:useBean class="nc.mairie.seat.process.OeAgent_PMateriel" id="process" scope="session"></jsp:useBean>
...
<%if((null==process.origine)||("".equals(process.origine))){ %>
			...
			<TR>
				...
				<INPUT type="text" name="<%=process.getNOM_EF_AGENT() %>"
					...
					size="10"></TD>
				<TD></TD>
				<TD><INPUT type="submit" name="<%= process.getNOM_PB_AGENT()%>" checked="checked"
...
<TABLE border="3" bordercolor="#669999" cellpadding="2"
		 ...
		 <tr>
			...
			<tr>
				...
				<TABLE>
					<TR>
						<TD><%if (process.isVide) {%><INPUT type="submit"
							value="Visualiser" name="<%=process.getNOM_PB_VISUALISER() %>" class="sigp2-Bouton-100"><%} %></TD>
						<TD width="10"></TD>
