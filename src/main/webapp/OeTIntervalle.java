...
public class OeTIntervalle extends nc.mairie.technique.BasicProcess {
	...
	private String ACTION_MODIFICATION = "Modification d'un type d'intervalle.";
...
//	Si aucune action en cours
	...
	String newDesignation = getZone(getNOM_EF_LIBELLE());
	...
	//Si Action Modification
		...
		//Modification
		getTintervalleCourant().modifierTIntervalle(getTransaction());
		if (getTransaction().isErreur())
			return false;
	...
	//Si Action Creation		
		...
		//Création
		getTintervalleCourant().creerTIntervalle(getTransaction());
		if (getTransaction().isErreur())
			return false;
