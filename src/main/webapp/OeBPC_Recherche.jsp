...
<TITLE>OeBPC_Recherche.jsp</TITLE>
</HEAD>
<jsp:useBean class="nc.mairie.seat.process.OeBPC_Recherche" id="process" scope="session"></jsp:useBean>
      ...
      <TD style="text-align : center;">
		...
		<FIELDSET><LEGEND class="sigp2Fieldset" align="left">Equipements</LEGEND><TABLE border="0" class="sigp2">
				...
				<TR>
					...
					ondblclick='executeBouton("<%= process.getNOM_PB_OK_EQUIPEMENT()%>")'>
...
<FIELDSET><LEGEND class="sigp2Fieldset" align="left">BPC</LEGEND><TABLE border="0" class="sigp2">
				<TR align="center">
					<TD align="left" height="35">
				<TABLE width="100%" border="1">
					<TBODY>
						<TR>
							<TD class="sigp2-titre-liste">N°BPC         Date    Compteur        Quantité  </TD>
						</TR>
					</TBODY>
				</TABLE>
				</TD>
