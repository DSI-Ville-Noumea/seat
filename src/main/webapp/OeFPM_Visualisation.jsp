...
<TITLE>OeFPM_Visualisation.jsp</TITLE>
</HEAD>
<jsp:useBean class="nc.mairie.seat.process.OeFPM_Visualisation" id="process" scope="session"></jsp:useBean>
...
<INPUT type="text" name="<%=process.getNOM_EF_NUMFICHE() %>"
				...
				<td><INPUT type="submit" value="Rechercher"
					name="<%=process.getNOM_PB_FPM() %>" class="sigp2-Bouton-100"></td>
          ...
          <TR>
            ...
            <TD valign="top" align="left" width="100%" class="OngletCorps">
								<TABLE class="sigp2">
									...
									<TR>
										<TD><SELECT size="8" name="<%= process.getNOM_LB_PIECES() %>"
											class="sigp2-liste"
											style="text-transform: uppercase; width: 100%">
          ...
          <TR>
            ...
            <TD valign="top" align="left" width="100%" class="OngletCorps">
								<TABLE class="sigp2">
									...
									<TR>
										<TD><SELECT size="8" name="<%= process.getNOM_LB_FRE() %>0"
											class="sigp2-liste"
											style="text-transform: uppercase; width: 100%">
