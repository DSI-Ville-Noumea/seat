...
<TITLE>OeCompteur.jsp</TITLE>
</HEAD>
<jsp:useBean class="nc.mairie.seat.process.OeCompteur" id="process" scope="session"></jsp:useBean>
      ...
      <TD style="text-align : center;" width="681"><FORM name="formu" method="POST"><FIELDSET><LEGEND class="sigp2Fieldset" align="left"></LEGEND><TABLE border="0" cellspacing="0" cellpadding="0" class="sigp2">
				<TR>
					...
					<TABLE border="0" class="sigp2">
						<TR align="center">
							<TD width="122">La liste des compteurs</TD>
						</TR>
					</TABLE>
					</TD>
				</TR>
				<TR>
					<TD>
						<SELECT size="5" name="<%= process.getNOM_LB_COMPTEUR() %>"
					...
					<TABLE border="0" class="sigp2">
						<TR align="center">
							...
							<%if ("".equals(process.getVAL_ST_DESIGNATION())){ %>
								<INPUT type="text" name="<%= process.getNOM_EF_DESIGNATION() %>"
								class="sigp2-saisie" value="<%= process.getVAL_EF_DESIGNATION()%>" maxlength="30" size="30" style="text-transform: uppercase">
							<%}else{ %>
