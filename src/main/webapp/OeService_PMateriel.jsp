...
<jsp:useBean class="nc.mairie.seat.process.OeService_PMateriel" id="process" scope="session"></jsp:useBean>
...
<%if (!process.menuService){ %>
				...
				<td><INPUT type="image" border="0" src="images/jumelle.gif"
					width="21" height="17"
					name="<%=process.getNOM_PB_SCE_RECHERCHE() %>" align="middle"></td>
							</tr>
						</TABLE>
<%} %>
<TABLE border="3" bordercolor="#669999" cellpadding="2"
		...
		<TABLE border="0" class="sigp2">
			...
			<TR>
				<TD colspan="3"><SELECT size="10"
					name="<%= process.getNOM_LB_EQUIP() %>" class="sigp2-liste"
					style="text-transform: uppercase; width: 100%"
					onclick='executeBouton("<%= process.getNOM_PB_RESPONSABLE()%>")'>
...
<%} %>
			<TR>
				<TD colspan="3"><INPUT type="submit" value="Responsable"
					...
					style="visibility : hidden;" class="sigp2-Bouton-100"></TD>
			</TR>
			<TR>
				<TD>
				<TABLE align="center">
					<TR>
						...
						<TD align="left" width="151"><INPUT type="submit"
							value="Visualiser" name="<%=process.getNOM_PB_VISUALISER() %>"
							style="visibility : hidden;" class="sigp2-Bouton-100"></TD>
						<TD><INPUT type="submit" value="Tableau de bord"
							name="<%=process.getNOM_PB_TDB() %>" style="visibility : hidden;"
