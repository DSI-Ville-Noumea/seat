...
<%@ include file="BanniereErreur.jsp" %>
    <TR>
      <TD style="text-align : center;">
			<FORM name="formu" method="POST"><SPAN class="sigp2-titre">Les OT : impression<INPUT
			type="submit" value="OK" name="<%=process.getNOM_PB_OK_OT() %>"
		...
		<FIELDSET><LEGEND class="sigp2Fieldset" align="left"></LEGEND><TABLE border="0" class="sigp2">
				...
				<TABLE class="sigp2" border="0" cellspacing="1">
					<TR>
						...
						<TABLE class="sigp2" border="1">
							<TR>
								<TD height="29" class="sigp2-titre-liste">N°OT       Immat.     Entretien                                 </TD>
			...
			<TABLE class="sigp2" border="0">
				...
				<TR>
					...
					name="<%= process.getNOM_PB_DETAILS_OT() %>"
					value="Détails de l'OT" class="sigp2-Bouton-100"></TD>
				<TD></TD>
				<TD><INPUT type="submit"
					name="<%= process.getNOM_PB_MODIFIER_OT() %>"
					value="Modifier l'OT" class="sigp2-Bouton-100"></TD>
				<TD></TD>
