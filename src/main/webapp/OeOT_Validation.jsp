...
<FIELDSET><LEGEND class="sigp2Fieldset" align="left">OT non validé</LEGEND><TABLE border="0" class="sigp2">
				<TR align="center">
				...
				<TR>
					<TD align="left">
						<SELECT size="8" name="<%= process.getNOM_LB_OTENCOURS() %>"
					class="sigp2-liste" style="text-transform: uppercase; width: 100%"
					ondblclick='executeBouton("<%= process.getNOM_PB_AJOUTER()%>")'>
					<%= process.forComboHTML(process.getVAL_LB_OTENCOURS(),process.getVAL_LB_OTENCOURS_SELECT()) %>
				</SELECT>
				</TR>
<%if (!process.isListOtEncoursVide()){ %>
				<tr>
					<td align="center">
...
<FIELDSET><LEGEND class="sigp2Fieldset" align="left">OT à valider</LEGEND><TABLE border="0" class="sigp2">
				<TR align="center">
					<TD align="left" height="35">
				<TABLE class="sigp2" border="1">
					<TR>
				...
				<TR>
					<TD align="left">
						<SELECT size="4" name="<%= process.getNOM_LB_OTAVALIDER() %>"
					class="sigp2-liste" style="text-transform: uppercase; width: 100%"
					ondblclick='executeBouton("<%= process.getNOM_PB_ENLEVER()%>")'>
					<%= process.forComboHTML(process.getVAL_LB_OTAVALIDER(),process.getVAL_LB_OTAVALIDER_SELECT()) %>
				</SELECT>
				</TR>
		...
		<TABLE border="0" class="sigp2">
			...
			<TR>
				<TD align="left"><SELECT size="4"
					name="<%= process.getNOM_LB_OTAVALIDER() %>" class="sigp2-liste"
