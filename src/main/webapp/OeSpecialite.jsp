...
<TITLE>OeSpecialite.jsp</TITLE>
</HEAD>
<jsp:useBean class="nc.mairie.seat.process.OeSpecialite" id="process" scope="session"></jsp:useBean>
...
<%@ include file="BanniereErreur.jsp" %>
    <TR>
      <TD style="text-align : center;" width="681"><FORM name="formu" method="POST"><FIELDSET><LEGEND class="sigp2Fieldset" align="left"></LEGEND><TABLE border="0" cellspacing="0" cellpadding="0" class="sigp2">
				<TR>
					<TD height="26">
					<TABLE border="0" class="sigp2" width="250">
						<TR align="center">
							<TD>La liste des spécialités&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
						</TR>
					</TABLE>
					</TD>
				</TR>
				<TR>
					<TD>
						<SELECT size="10" name="<%= process.getNOM_LB_SPECIALITE() %>"
