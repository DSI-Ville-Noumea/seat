		...
		<TABLE border="0" class="sigp2">
			...
			<tr>
				...
				<TABLE border="3" width="100%" bordercolor="#669999" cellpadding="2"
					...
					<TR>
						<TD colspan="3" bgcolor="#669999" class="sigp2-titre">Détails d'une fiche</TD>
					</TR>
					<TR>
						<TD width="10"></TD>
						<TD><!--Détails du BPC-->
...
<tr>
	<td colspan="5"><FIELDSET>
								<TABLE class="sigp2">
									...
									<TR>
										<TD width="151" align="left"><INPUT type="submit"
											name="<%=process.getNOM_PB_AJOUTPIECES() %>" value="Ajouter"
											class="sigp2-Bouton-100"></TD>
										<TD width="151" align="left"><INPUT type="submit"
											name="<%=process.getNOM_PB_MODIFPIECES() %>"
											class="sigp2-Bouton-100" value="Modifier"></TD>
										<TD><INPUT type="submit"
											name="<%=process.getNOM_PB_SUPPIECES() %>" value="Supprimer"
											class="sigp2-Bouton-100"></TD>
									</TR>
								</TABLE>
</fieldset>
